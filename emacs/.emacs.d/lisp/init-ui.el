...
(defvar yx/default-font-family "Cascadia Code")
(defvar yx/fixed-patch-font-family "Cascadia Code")
(defvar yx/variable-patch-font-family "Cascadia Code")

(defun font-installed-p (font-name)
  (find-font (font-spec :name font-name)))
(defun yx/setup-fonts ()
  (set-face-attribute 'default nil
                      :family yx/default-font-family :height 160)
  (set-face-attribute 'fixed-pitch nil
                      :family yx/fixed-patch-font-family :height 1.0)
  (set-face-attribute 'variable-pitch nil
                      :family yx/variable-patch-font-family :height 1.0)
